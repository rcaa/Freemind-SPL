 ...
 */
/*$Id: RemoveLastIconAction.java,v 1.1.4.2 2005/06/30 20:57:01 christianfoltin Exp $*/
 ...
 * 
 */
public class RemoveLastIconAction extends NodeGeneralAction implements
		NodeActorXml {
	...
	public ActionPair apply(MapAdapter model, MindMapNode selected)
		...
		AddIconAction undoAction = iconAction.createAddIconAction(selected,
				(MindIcon) icons.get(icons.size() - 1));
		return new ActionPair(createRemoveLastIconXmlAction(selected),
				undoAction);
	}
	...
	public RemoveLastIconXmlAction createRemoveLastIconXmlAction(
			MindMapNode node) throws JAXBException {
		RemoveLastIconXmlAction action = modeController.getActionXmlFactory()
