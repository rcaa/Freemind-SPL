 ...
 * @version $Name: fm-0-8-1 $, $Revision: 1.7.18.3 $
 */
public class XMLElement {
	 ...
	 * doesn't exist, the value corresponding to defaultKey is returned.
	 * <P>
	 * As an example, if valueSet contains the mapping <code>"one" =&gt; 1.0
	 * </code> and the element contains the attribute <code>attr="one"</code>,
