 ...
 */
/*$Id: MindMapActions.java,v 1.1.4.15 2005/07/02 23:19:38 christianfoltin Exp $*/
...
public interface MindMapActions {
	 ...
	 */
	MindMapNode addNewNode(MindMapNode parent, int index,
	 ...
	 *            list of ApplyPatternActions from the ControllerAdapter. Each
...
//	 public void setCloudColor(MindMapNode node, Color color);
	 ...
	 * 
	 * @param focussed
	 *            will be focussed afterwards
	 * @param selecteds
	 *            are all nodes that are selected (the focussed has not to be
	 *            contained).
	 */
	 ...
	 * 
	 * On extend = false clear up the previous selection. if extend is false,
	 * the past selection will be empty. if yes, the selection will extended
	 * with this node and its children
	 */
