 ...
 */
/*$Id: LineAdapter.java,v 1.2.18.2 2005/06/14 20:38:07 christianfoltin Exp $*/
...
public abstract class LineAdapter implements MindMapLine {
	...
	public void setWidth(int width) {
		this.width = width;
		stroke = new BasicStroke(getWidth(), BasicStroke.CAP_BUTT,
	...
	public class LineAdapterListener implements FreemindPropertyListener {
