...
import freemind.modes.EdgeAdapter; //CLOUDS
//import freemind.modes.CloudAdapter;
import freemind.modes.ArrowLinkAdapter;
import freemind.modes.XMLElementAdapter;
import freemind.modes.browsemode.BrowseEdgeModel; //CLOUDS
...
public class BrowseXMLElement extends XMLElementAdapter {
	...
	protected BrowseXMLElement(FreeMindMain frame, Vector ArrowLinkAdapters,
			HashMap IDToTarget) {
