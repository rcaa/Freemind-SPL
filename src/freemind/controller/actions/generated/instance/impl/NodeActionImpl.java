    ...
    implements freemind.controller.actions.generated.instance.NodeAction, com.sun.xml.bind.JAXBObject, freemind.controller.actions.generated.instance.impl.runtime.UnmarshallableObject, freemind.controller.actions.generated.instance.impl.runtime.XMLSerializable, freemind.controller.actions.generated.instance.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (freemind.controller.actions.generated.instance.NodeAction.class);
    }
    ...
    public freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingEventHandler createUnmarshaller(freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingContext context) {
        return new freemind.controller.actions.generated.instance.impl.NodeActionImpl.Unmarshaller(context);
    }
...
+"ppppppppppp"));
        ...
        extends freemind.controller.actions.generated.instance.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return freemind.controller.actions.generated.instance.impl.NodeActionImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        spawnHandlerFromEnterElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.NodeActionImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  4 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        spawnHandlerFromLeaveElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.NodeActionImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  4 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        spawnHandlerFromEnterAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.NodeActionImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  4 :
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  3 :
                        spawnHandlerFromLeaveAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.NodeActionImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  4 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  3 :
                            spawnHandlerFromText((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.NodeActionImpl.this).new Unmarshaller(context)), 4, value);
                            return ;
                        case  1 :
                            eatText0(value);
                            state = 2;
