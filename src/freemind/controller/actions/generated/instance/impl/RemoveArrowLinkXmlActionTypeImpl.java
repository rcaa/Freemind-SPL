    ...
    implements freemind.controller.actions.generated.instance.RemoveArrowLinkXmlActionType, com.sun.xml.bind.JAXBObject, freemind.controller.actions.generated.instance.impl.runtime.UnmarshallableObject, freemind.controller.actions.generated.instance.impl.runtime.XMLSerializable, freemind.controller.actions.generated.instance.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (freemind.controller.actions.generated.instance.RemoveArrowLinkXmlActionType.class);
    }
    ...
    public freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingEventHandler createUnmarshaller(freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingContext context) {
        return new freemind.controller.actions.generated.instance.impl.RemoveArrowLinkXmlActionTypeImpl.Unmarshaller(context);
    }
...
+"ean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0001xp\u0003s\u00fcyppsr\u0000\u001bcom.sun.msv.grammar.DataE"
...
+".msv.grammar.NameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xpt\u0000\u0002idt\u0000\u0000sr\u0000\"com.sun.msv.g"
...
+"ppppppppp"));
        ...
        extends freemind.controller.actions.generated.instance.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return freemind.controller.actions.generated.instance.impl.RemoveArrowLinkXmlActionTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  3 :
                        spawnHandlerFromEnterElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.RemoveArrowLinkXmlActionTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  3 :
                        spawnHandlerFromLeaveElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.RemoveArrowLinkXmlActionTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  3 :
                        spawnHandlerFromEnterAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.RemoveArrowLinkXmlActionTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  3 :
                        spawnHandlerFromLeaveAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.RemoveArrowLinkXmlActionTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            state = 3;
                ...
                try {
                    switch (state) {
                        ...
                        case  4 :
                            ...
                            return ;
                        case  3 :
                            spawnHandlerFromText((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.RemoveArrowLinkXmlActionTypeImpl.this).new Unmarshaller(context)), 4, value);
                            return ;
                        case  1 :
                            eatText0(value);
                            state = 2;
