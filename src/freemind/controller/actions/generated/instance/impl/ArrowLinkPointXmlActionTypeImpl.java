    ...
    implements freemind.controller.actions.generated.instance.ArrowLinkPointXmlActionType, com.sun.xml.bind.JAXBObject, freemind.controller.actions.generated.instance.impl.runtime.UnmarshallableObject, freemind.controller.actions.generated.instance.impl.runtime.XMLSerializable, freemind.controller.actions.generated.instance.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (freemind.controller.actions.generated.instance.ArrowLinkPointXmlActionType.class);
    }
    ...
    public void setStartPoint(java.lang.String value) {
        _StartPoint = value;
    }
    ...
    public freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingEventHandler createUnmarshaller(freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingContext context) {
        return new freemind.controller.actions.generated.instance.impl.ArrowLinkPointXmlActionTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (_StartPoint!= null) {
            context.startAttribute("", "start_point");
            try {
                context.text(((java.lang.String) _StartPoint));
        ...
        if (_EndPoint!= null) {
            context.startAttribute("", "end_point");
            try {
                context.text(((java.lang.String) _EndPoint));
            } catch (java.lang.Exception e) {
                freemind.controller.actions.generated.instance.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endAttribute();
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\b\u00e9\u00a7\u0017ppsq\u0000~\u0000\u0000\u0005\u00aeN\u00ebppsr\u0000\u001dcom"
+".sun.msv.grammar.ChoiceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001\u0003\u0000y?ppsr\u0000 com.sun"
+".msv.grammar.AttributeExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003expq\u0000~\u0000\u0002L\u0000\tnameClasst"
+"\u0000\u001fLcom/sun/msv/grammar/NameClass;xq\u0000~\u0000\u0003\u0003\u0000y4sr\u0000\u0011java.lang.Boo"
...
+".grammar.NameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xpt\u0000\u000bstart_pointt\u0000\u0000sr\u00000com.sun."
+"msv.grammar.Expression$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003\u0000\u0000\u0000"
+"\tsq\u0000~\u0000\f\u0001q\u0000~\u0000(sq\u0000~\u0000\u0007\u0002\u00ad\u00d5\u00a7ppsq\u0000~\u0000\t\u0002\u00ad\u00d5\u009cq\u0000~\u0000\rpq\u0000~\u0000\u0011sq\u0000~\u0000\"t\u0000\tend_p"
+"ointq\u0000~\u0000&q\u0000~\u0000(sq\u0000~\u0000\t\u0003;X\'ppq\u0000~\u0000\u0011sq\u0000~\u0000\"t\u0000\u0002idq\u0000~\u0000&sr\u0000\"com.sun.m"
...
+"ppq\u0000~\u0000\u0005pppppppppppppppppppppppppppppppppppppppppq\u0000~\u0000*ppq\u0000~\u0000\u0006"
+"pppppppppppppppppppppppq\u0000~\u0000\bp"));
        }
        ...
        extends freemind.controller.actions.generated.instance.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return freemind.controller.actions.generated.instance.impl.ArrowLinkPointXmlActionTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        attIdx = context.getAttribute("", "end_point");
                        if (attIdx >= 0) {
                    ...
                    case  6 :
                        ...
                        break;
                    case  0 :
                        attIdx = context.getAttribute("", "start_point");
                        if (attIdx >= 0) {
                            final java.lang.String v = context.eatAttribute(attIdx);
                            eatText2(v);
                            state = 3;
                        ...
                        continue outer;
                    case  9 :
                        spawnHandlerFromEnterElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.ArrowLinkPointXmlActionTypeImpl.this).new Unmarshaller(context)), 10, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        continue outer;
                    case  9 :
                        spawnHandlerFromLeaveElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.ArrowLinkPointXmlActionTypeImpl.this).new Unmarshaller(context)), 10, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  6 :
                        ...
                        break;
                    case  0 :
                        if (("start_point" == ___local)&&("" == ___uri)) {
                            state = 1;
                            return ;
                        }
                        state = 3;
                        continue outer;
                    case  9 :
                        spawnHandlerFromEnterAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.ArrowLinkPointXmlActionTypeImpl.this).new Unmarshaller(context)), 10, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        continue outer;
                    case  9 :
                        spawnHandlerFromLeaveAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.ArrowLinkPointXmlActionTypeImpl.this).new Unmarshaller(context)), 10, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  0 :
                            ...
                            continue outer;
                        case  9 :
                            spawnHandlerFromText((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.ArrowLinkPointXmlActionTypeImpl.this).new Unmarshaller(context)), 10, value);
                            return ;
                    }
