    ...
    implements freemind.controller.actions.generated.instance.UndoXmlActionType, com.sun.xml.bind.JAXBObject, freemind.controller.actions.generated.instance.impl.runtime.UnmarshallableObject, freemind.controller.actions.generated.instance.impl.runtime.XMLSerializable, freemind.controller.actions.generated.instance.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (freemind.controller.actions.generated.instance.UndoXmlActionType.class);
    }

    public java.lang.String getRemedia() {
        return _Remedia;
    }

    public void setRemedia(java.lang.String value) {
        _Remedia = value;
    }
    ...
    public freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingEventHandler createUnmarshaller(freemind.controller.actions.generated.instance.impl.runtime.UnmarshallingContext context) {
        return new freemind.controller.actions.generated.instance.impl.UndoXmlActionTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_Remedia!= null) {
            context.startAttribute("", "remedia");
            try {
                context.text(((java.lang.String) _Remedia));
            } catch (java.lang.Exception e) {
                freemind.controller.actions.generated.instance.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endAttribute();
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0004\u00e3\u00de7ppsr\u0000 com.sun.msv.gra"
+"mmar.AttributeExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003expq\u0000~\u0000\u0002L\u0000\tnameClasst\u0000\u001fLcom/s"
+"un/msv/grammar/NameClass;xq\u0000~\u0000\u0003\u0002R\u00adqppsr\u0000\u001bcom.sun.msv.grammar"
...
+"om.sun.msv.grammar.NameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xpt\u0000\u000bdescriptiont\u0000\u0000sr"
+"\u0000\u001dcom.sun.msv.grammar.ChoiceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001\u0002\u00910\u00c1ppsq\u0000~\u0000\u0006"
+"\u0002\u00910\u00b6sr\u0000\u0011java.lang.Boolean\u00cd r\u0080\u00d5\u009c\u00fa\u00ee\u0002\u0000\u0001Z\u0000\u0005valuexp\u0000pq\u0000~\u0000\fsq\u0000~\u0000\u001dt"
+"\u0000\u0007remediaq\u0000~\u0000!sr\u00000com.sun.msv.grammar.Expression$EpsilonExpr"
+"ession\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003\u0000\u0000\u0000\tsq\u0000~\u0000%\u0001q\u0000~\u0000*sr\u0000\"com.sun.msv.gramm"
...
+"ppppppppppppp"));
        ...
        extends freemind.controller.actions.generated.instance.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return freemind.controller.actions.generated.instance.impl.UndoXmlActionTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        attIdx = context.getAttribute("", "remedia");
                        if (attIdx >= 0) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  6 :
                        spawnHandlerFromEnterElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.UndoXmlActionTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  6 :
                        spawnHandlerFromLeaveElement((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.UndoXmlActionTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  6 :
                        spawnHandlerFromEnterAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.UndoXmlActionTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  6 :
                        spawnHandlerFromLeaveAttribute((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.UndoXmlActionTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  5 :
                        if (("remedia" == ___local)&&("" == ___uri)) {
                            state = 6;
                ...
                try {
                    switch (state) {
                        ...
                        case  0 :
                            ...
                            break;
                        case  6 :
                            spawnHandlerFromText((((freemind.controller.actions.generated.instance.impl.XmlActionImpl)freemind.controller.actions.generated.instance.impl.UndoXmlActionTypeImpl.this).new Unmarshaller(context)), 7, value);
                            return ;
                    }
