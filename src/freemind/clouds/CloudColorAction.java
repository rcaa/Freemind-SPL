 ...
 */
/* $Id: CloudColorAction.java,v 1.1.4.1 2004/10/17 23:00:08 dpolivaev Exp $ */
...
public class CloudColorAction extends FreemindAction implements ActorXml,
	...
	private static final long serialVersionUID = 8258594760257719543L;
	...
	public void setCloudColor(MindMapNode node, Color color) {
		try {
			CloudColorXmlAction doAction = createCloudColorXmlAction(node,
					color);
			CloudColorXmlAction undoAction = createCloudColorXmlAction(node,
					(node.getCloud() == null) ? null : node.getCloud()
							.getColor());
	...
	public CloudColorXmlAction createCloudColorXmlAction(MindMapNode node,
			Color color) throws JAXBException {
		CloudColorXmlAction nodeAction = controller.getActionXmlFactory()
